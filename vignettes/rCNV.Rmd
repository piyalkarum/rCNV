...
download.file("https://drive.google.com/uc?export=download&id=141-RRGKJaioGWuJxBOAz3D-nUmNI36LZ","Parrotfish_sequenceReads.vcf.gz",method="wget", quiet = T)
parrot<-readVCF("Parrotfish_sequenceReads.vcf.gz",verbose=F)
