...
fl<-paste0(tempdir(),"Parrotfish_sequenceReads.vcf.gz")
download.file("https://drive.google.com/uc?export=download&id=141-RRGKJaioGWuJxBOAz3D-nUmNI36LZ",fl,method="wget", quiet = T)
