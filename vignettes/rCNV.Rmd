...
|   a. Allele ratios (across all samples)
|   b. Proportions of homo-/heterozygotes per SNP
|   c. Depth ratios (alternative/sum)
|   d. Z-score
|   e. Chi-square significance
...
![Fig 2.1 Median allele ratio Vs Prop. of Heterozygotes with putative duplicates](dupPlot.png)
