...
#'
#' @param gt multi-vector. an imported data.frame of genotypes or genotype data frame generated by "hetTgen" or path to GT.FORMAT file generated from VCFTools
